...
Interactive Swagger UI is served from the running application at:

- Swagger UI: <http://localhost:3000/api/docs>
- OpenAPI JSON spec: <http://localhost:3000/api/docs-json>

The spec is generated automatically by `@nestjs/swagger` from controller
decorators (`@ApiTags`, `@ApiOperation`, `@ApiOkResponse`, etc.). Annotate
new endpoints the same way to keep the documentation in sync with the code.
